% =============================================================================
%  Nour — A Hallucination-Resistant RAG Pipeline for Egyptian Criminal Law
%
...
\title{Nour: A Hallucination-Resistant Retrieval-Augmented Generation Pipeline
for Egyptian Criminal Law in Arabic}

% Authors --------------------------------------------------------------------
\author[a]{Mirna Nageh\corref{cor1}}
\ead{novagatesemployee@gmail.com}
...
but legally-inadequate context. We present \textbf{Nour}, a production-grade
...
We then present \textbf{Nour} (\ar{نور}), a hallucination-resistant Arabic
legal-AI assistant built on top of this corpus. Nour layers a six-mechanism
...
Nour is implemented as a FastAPI service backed by the 47{,}028-chunk
...
The Nour prompt suite addresses these failure modes with eight rules
...
and \textbf{Nour}, a hallucination-resistant Arabic legal RAG system built on
