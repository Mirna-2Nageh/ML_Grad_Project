...
PROMPTS = {
    ...
    "weakness": (
        ...
        "facts below. Do NOT invent facts, article numbers, or rulings.\n\n"
        "Provided Legal Texts:\n{legal_refs}\n\n"
        "Case Facts:\n{case_facts}\n\n"
        "Produce a numbered analysis across: (1) أوجه القصور الإجرائية، (2) ضعف الأدلة، (3) نقص أركان الجريمة، "
        "(4) الظروف المخففة أو المبيحة. Tie each point to a specific fact or article number; if a dimension has no "
        "weakness or the facts are insufficient, say so explicitly.\n\n"
        "تحليل نقاط الضعف (بالعربية):"
    ),
    "defense": (
        "Draft an Egyptian criminal-court defense memorandum using ONLY the legal texts and facts below. "
        ...
        "الطلبات. Cite an article number from the provided texts for each legal point. If facts are insufficient, "
        "state what is missing instead of fabricating a defense.\n\n"
        "مذكرة الدفاع:"
    ),
    "chat": (
